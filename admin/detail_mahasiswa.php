                    ...
                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                        <div class="card-body">
                            <form action="../actions/edit_siswa.php" method="post">
                                <p class="text-danger font-italic">*Hati-hati dan pastikan kembali jika mengubah data Mahasiswa, salah mengubah data siswa dapat menyebabkan hal yang tidak diinginkan</p>
                                <div class="row">
                                    <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <option value="VI">VI</option> -->
                                                <option value="VII" <?= $siswa->tingkatan == "VII" ? "selected" : "" ?>>S1</option>
                                                <option value="VIII" <?= $siswa->tingkatan == "VIII" ? "selected" : "" ?>>S2</option>
                                                <option value="IV" <?= $siswa->tingkatan == "IV" ? "selected" : "" ?>>S3</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="nisn_siswa">No BP Siswa</label>
